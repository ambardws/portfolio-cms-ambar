...
export interface ApiOverviewOverview extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heading: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Overview'>;
...
export interface ApiProfileCollectionProfileCollection
  extends Struct.SingleTypeSchema {
  collectionName: 'profile_collections';
  info: {
    displayName: 'Profile';
    pluralName: 'profile-collections';
    singularName: 'profile-collection';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::profile-collection.profile-collection'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
...
export interface ApiTechStackTechStack extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['frontend', 'backend', 'tools', 'design', 'database', 'devops']
    > &
...
export interface ApiWorkExperienceWorkExperience
  ...
  attributes: {
    ...
    isCurrentJob: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::profile-collection.profile-collection': ApiProfileCollectionProfileCollection;
